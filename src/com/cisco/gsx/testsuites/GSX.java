...
public class GSX {
	...
	public void PrimaryupdateReservation_SecondaryCancel(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
	...
	public void acceptHotelRoomateRequest(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			...
			LoginPage.validateLoginPage();
			LoginPage.login(pojo);
			if(pojo.getRegCode().equalsIgnoreCase("EIDHoiliday")){ 
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=5)
	public void changeReservationWhenRoomShareNo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("Change Reservation dates for SingleRoom uesres(Room Share No)");
			//Validate login page
			LoginPage.validateLoginPage();
			LoginPage.login(pojo);
			GSX_HotelReservation.validatePaymentInfo();
			...
			this.tearDown("Change Reservation dates for SingleRoom uesres(Room Share No)");
			}
	}
	...
	public void attendee_updateContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void attendee_updateOnSiteInfo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void attendee_updatekeyQuestions(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void executive_updateContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateContactInformation");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void executive_updateOnSiteInfo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateOnSiteInfo");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void executive_updatekeyQuestions(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updatekeyQuestions");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void Hub_updateContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateContactInformation");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void Hub_updateOnSiteInfo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateOnSiteInfo");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void Hub_updatekeyQuestions(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updatekeyQuestions");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void event_updateContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateContactInformation");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void event_updateOnSiteInfo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateOnSiteInfo");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void event_updatekeyQuestions(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updatekeyQuestions");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void support_updateContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateContactInformation");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void support_updateOnSiteInfo(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updateOnSiteInfo");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void support_updatekeyQuestions(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("updatekeyQuestions");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class,priority=7)
	public void updateEIDContactInformation(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
			this.setUp("EID updateContactInformation");
			...
			//Click on Edit Contact information
			EID_HolidayList.updateEIDContactInformation();
		    EID_HolidayList.validateRegistrationPage();
		    EID_HolidayList.enterEIDContactInformation(pojo);
			...
			this.tearDown("EID updateContactInformation");
	...
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
	public void verifySessionPillar(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
		this.setUp("verify Session Pillar");
		...
		SessionCatalog.sessionPillar();

		this.tearDown("verify Session Pillar");
		}
	}
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
	public void verifySearch(LinkedList<?> pojo1) throws Exception {
		for (int a = 0; a < pojo1.size(); a++) {
			DataPojoClass pojo = (DataPojoClass) pojo1.get(a);
		this.setUp("verifySearch");
		...
		SessionCatalog.search();

		this.tearDown("verifySearch");
		}
	}
	@Test(dataProvider = "data-provider", dataProviderClass = Dataproviderclass.class)
